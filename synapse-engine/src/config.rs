...
impl SynapseConfig {
    pub fn builder() -> SynapseConfigBuilder {
        SynapseConfigBuilder::default()
    }
    ...
    pub fn into_builder(self) -> SynapseConfigBuilder {
        SynapseConfigBuilder(self)
    }
}

#[derive(Debug, Default, Clone, PartialEq, Eq, derive_more::Into)]
pub struct SynapseConfigBuilder(SynapseConfig);

impl SynapseConfigBuilder {
    ...
    pub fn build(self) -> SynapseConfig {
        self.0
    }
}
