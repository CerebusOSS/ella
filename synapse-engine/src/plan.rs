...
use crate::{codec::RemoteExtensionCodec, engine::SynapseState};
...
impl Plan {
    ...
    pub fn resolve(&self, state: &SynapseState) -> crate::Result<LogicalPlan> {
...
impl PlanInner {
    fn resolve(&self, state: &SynapseState) -> crate::Result<LogicalPlan> {
        Ok(match self {
